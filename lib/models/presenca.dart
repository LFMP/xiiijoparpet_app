...
class PresencaModel extends APIResponse {
  ...
  factory PresencaModel.fromJson(Map<String, dynamic> json) => json == null
      ? PresencaModel()
      : PresencaModel(
          dataPresenca: json["dataPresenca"] == null
              ? null
              : DateTime.parse(json["dataPresenca"]),
          responsavelPresencaId: json["responsavelPresencaId"] == null
              ? null
  ...
  Map<String, dynamic> toJson() => {
        "dataPresenca": dataPresenca == null
            ? null
            : dataPresenca.toIso8601String().toString(),
        "responsavelPresencaId": responsavelPresencaId == null
            ? null
  ...
  static List<PresencaModel> fromJsonList(List jsonList) => jsonList == null
      ? []
      : jsonList
          .map((presencaJson) => PresencaModel.fromJson(presencaJson))
          .toList();
}
